        ...
        <div class="col-md-9">
            ...
            <div class="col-md-8 blackboard">
                ...
                <div class="button_blackboard">
                    ...
                    <a class="btn btn-warning" href="{{url('/room/writeboard/'.$room->id)}}" style="width:180px"><i class="fa fa-pencil-square-o"
                                                                                                                    aria-hidden="true"></i>
                        Write the board</a>
                    <a class="btn btn-success" href="{{url('/room/senddocument/'.$room->id)}}" style="width:180px"><i class="fa fa-paper-plane"
                                                                                                                      aria-hidden="true"></i>
                        Send Document</a>
