...
@section('content')
    ...
    <div class="row body_room">
        <div class="col-md-9">
            ...
            <div class="col-md-9 blackboard">
                <div id="blackboard_title"  class="title">
                    <p style="text-align: center; font-size: 18px; color: white">{{$room->desc}} </p>

                </div>
                <div id="blackboard_content"  class="discussion" style="min-height: 260px;">
                    <p style="text-align: left; font-size: 14px;margin-top: 5px; color: white">{{$room->desc1}} </p>
                </div>
                <div class="button_blackboard">
                    <a class="btn btn-success" href="{{url('')}}" style="width:180px"><i class="fa fa-picture-o" aria-hidden="true"></i> Add Image</a>
                    <a class="btn btn-warning" href="{{url('/room/writeboard1/'.$room->id)}}" style="width:180px"><i class="fa fa-pencil-square-o"
                                                                                                                     aria-hidden="true"></i>
                        Write the board</a>
                    <a class="btn btn-success" href="{{url('/room/senddocument1/'.$room->id)}}" style="width:180px"><i class="fa fa-paper-plane"
                                                                                                                       aria-hidden="true"></i>
                        Send Document</a>
    ...
    <script type="text/javascript">
        ...
        var title = document.getElementById("blackboard_title");
        var content = document.getElementById("blackboard_content")
        ...
        // notify -blackBoard
        var channel2 = pusher.subscribe('BlackBoard');
        channel2.bind('notify-blackBoard', function (data) {
            console.log("hello2");
            console.log(data);
            if (data.id_room ==id_room)
            {
