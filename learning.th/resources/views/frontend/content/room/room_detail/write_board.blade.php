        ...
        <div class="col-md-8 blackboard">
               ...
               <div class="discussion">
                     <form action="{{url('room/writeboard/'.$room->id)}}" method="post">
                         @csrf
                         <div>
                             <input name="desc" type="text"  style="width: 95%; height: 50px" placeholder="title">
                             <textarea name="desc1" id="" class="form-control1 mytinymce" cols="50" rows="4" style="width: 95%; height: 200px"
                                       placeholder="Detail"></textarea>
                         </div>
                         <input  class="btn btn-warning" type="submit" value="Write" style="margin-top: 10px"></input>
                     </form>
               </div>
