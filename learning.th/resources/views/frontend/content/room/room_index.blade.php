            ...
            @foreach($rooms as $room)
                <div class="col-md-3" style="margin-top:10px">
                    <div class="room_image">
                        <img src="{{ asset($room->images) }}" class="img-responsive" style="width:230px; height:150px;
                    ...
                    <div class="row" style="margin-top: 15px">
                        ...
                        <div class="col-md-4 join_room">
                                  <a class="btn btn-success" href="{{url('/room/detail/'.$room->id)}}" style="/*width:150px*/">Join</a>
                         </div>
                    </div>
                </div>
            @endforeach
