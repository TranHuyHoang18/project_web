...
@section('content')
    ...
    <div class="services">
        <div class="container">
            <div class="w3layouts_header">
                <h2>Thanh <span>Nguyen Huu</span></h2>
  ...
  Có  như vậy mới không lỗi.”
                    ...
                    Họ và tên : <h4>Nguyễn Hữu Thanh</h4><br>
                    ...
                    Chức vụ trong nhóm: Nhóm phó <br>
                    Hoàn thành sản phẩm: 6/05/2019<br>

                </div>
                <div class="col-md-6 agileinfo_about_right">
                    <img src="{{asset('front_assets/images/about/thanh.jpg')}}" alt=" " class="img-responsive"  style="width: 450px; height: 450px;
