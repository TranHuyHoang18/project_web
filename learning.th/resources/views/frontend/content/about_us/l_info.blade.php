...
@section('content')
    ...
    <div class="services">
        <div class="container">
            <div class="w3layouts_header">
                <h2>Linh <span>Duong Khanh</span></h2>
  ...
  Có  như vậy mới không lỗi.”
                    ...
                    Họ và tên : <h4>Dương Khánh Linh</h4><br>
                ...
                <div class="col-md-6 agileinfo_about_right">
                    <img src="{{asset('front_assets/images/about/linh.jpg')}}" alt=" " class="img-responsive"  style="width: 450px; height: 450px;
